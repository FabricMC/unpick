...
public class TestSimpleConstantUninlining {
	...
	private static void visitGroups(UnpickV3Visitor data) {
		data.visitGroupDefinition(GroupDefinition.Builder.named(DataType.INT, "byteConsts")
				.constant(new FieldExpression("pkg.Constants", "BYTE_CONST_M1", DataType.BYTE, true))
				.constant(new FieldExpression("pkg.Constants", "BYTE_CONST_0", DataType.BYTE, true))
				.constant(new FieldExpression("pkg.Constants", "BYTE_CONST_1", DataType.BYTE, true))
				.constant(new FieldExpression("pkg.Constants", "BYTE_CONST_2", DataType.BYTE, true))
				.constant(new FieldExpression("pkg.Constants", "BYTE_CONST_3", DataType.BYTE, true))
				.constant(new FieldExpression("pkg.Constants", "BYTE_CONST_4", DataType.BYTE, true))
				.constant(new FieldExpression("pkg.Constants", "BYTE_CONST_5", DataType.BYTE, true))
				.constant(new FieldExpression("pkg.Constants", "BYTE_CONST", DataType.BYTE, true))
				.build());
		data.visitGroupDefinition(GroupDefinition.Builder.named(DataType.INT, "shortConsts")
				.constant(new FieldExpression("pkg.Constants", "SHORT_CONST_M1", DataType.SHORT, true))
				.constant(new FieldExpression("pkg.Constants", "SHORT_CONST_0", DataType.SHORT, true))
				.constant(new FieldExpression("pkg.Constants", "SHORT_CONST_1", DataType.SHORT, true))
				.constant(new FieldExpression("pkg.Constants", "SHORT_CONST_2", DataType.SHORT, true))
				.constant(new FieldExpression("pkg.Constants", "SHORT_CONST_3", DataType.SHORT, true))
				.constant(new FieldExpression("pkg.Constants", "SHORT_CONST_4", DataType.SHORT, true))
				.constant(new FieldExpression("pkg.Constants", "SHORT_CONST_5", DataType.SHORT, true))
				.constant(new FieldExpression("pkg.Constants", "SHORT_CONST", DataType.SHORT, true))
				.build());
		data.visitGroupDefinition(GroupDefinition.Builder.named(DataType.INT, "charConsts")
				.constant(new FieldExpression("pkg.Constants", "CHAR_CONST_0", DataType.CHAR, true))
				.constant(new FieldExpression("pkg.Constants", "CHAR_CONST_1", DataType.CHAR, true))
				.constant(new FieldExpression("pkg.Constants", "CHAR_CONST_2", DataType.CHAR, true))
				.constant(new FieldExpression("pkg.Constants", "CHAR_CONST_3", DataType.CHAR, true))
				.constant(new FieldExpression("pkg.Constants", "CHAR_CONST_4", DataType.CHAR, true))
				.constant(new FieldExpression("pkg.Constants", "CHAR_CONST_5", DataType.CHAR, true))
				.constant(new FieldExpression("pkg.Constants", "CHAR_CONST", DataType.CHAR, true))
				.build());
		data.visitGroupDefinition(GroupDefinition.Builder.named(DataType.INT, "intConsts")
				.constant(new FieldExpression("pkg.Constants", "INT_CONST_M1", null, true))
				.constant(new FieldExpression("pkg.Constants", "INT_CONST_0", null, true))
				.constant(new FieldExpression("pkg.Constants", "INT_CONST_1", null, true))
				.constant(new FieldExpression("pkg.Constants", "INT_CONST_2", null, true))
				.constant(new FieldExpression("pkg.Constants", "INT_CONST_3", null, true))
				.constant(new FieldExpression("pkg.Constants", "INT_CONST_4", null, true))
				.constant(new FieldExpression("pkg.Constants", "INT_CONST_5", null, true))
		...
		data.visitGroupDefinition(GroupDefinition.Builder.named(DataType.LONG, "longConsts")
				.constant(new FieldExpression("pkg.Constants", "LONG_CONST_0", null, true))
				.constant(new FieldExpression("pkg.Constants", "LONG_CONST_1", null, true))
				.constant(new FieldExpression("pkg.Constants", "LONG_CONST", null, true))
				.build());
		data.visitGroupDefinition(GroupDefinition.Builder.named(DataType.FLOAT, "floatConsts")
				.constant(new FieldExpression("pkg.Constants", "FLOAT_CONST_0", null, true))
				.constant(new FieldExpression("pkg.Constants", "FLOAT_CONST_1", null, true))
				.constant(new FieldExpression("pkg.Constants", "FLOAT_CONST_2", null, true))
				.constant(new FieldExpression("pkg.Constants", "FLOAT_CONST", null, true))
				.build());
		data.visitGroupDefinition(GroupDefinition.Builder.named(DataType.DOUBLE, "doubleConsts")
				.constant(new FieldExpression("pkg.Constants", "DOUBLE_CONST_0", null, true))
				.constant(new FieldExpression("pkg.Constants", "DOUBLE_CONST_1", null, true))
				.constant(new FieldExpression("pkg.Constants", "DOUBLE_CONST", null, true))
				.build());
